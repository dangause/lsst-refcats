...
assert type(config) is lsst.meas.algorithms.convertReferenceCatalog.ConvertReferenceCatalogConfig, f"config is of type {type(config).__module__}.{type(config).__name__} instead of lsst.meas.algorithms.convertReferenceCatalog.ConvertReferenceCatalogConfig"
...
config.file_reader.fill_values=None
...
config.file_reader.replace_missing_floats_with_nan=False
...
config.full_position_information=False
